...
void populateProcedureTable(std::shared_ptr<Node> procedure, std::map<std::string, std::map<std::string, Variable>> &tables, std::map<std::string, Procedure> &procedureTable) {
